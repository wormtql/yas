...
use crate::info::window_info::{WINDOW_43_18, WINDOW_7_3, WINDOW_16_9, WINDOW_4_3, WINDOW_8_5, WINDOW_MAC_8_5};
...
impl ScanInfo {
    ...
    pub fn from_MAC_8_5(width: u32, height: u32, left: i32, top: i32) -> ScanInfo {
...
impl ScanInfo {
    pub fn from_rect(rect: &PixelRect) -> Result<ScanInfo, String> {
        ...
        if rect.height * 16 == rect.width * 9 {
            ...
            info = ScanInfo::from_MAC_8_5(rect.width as u32, rect.height as u32, rect.left, rect.top);
        } else {
