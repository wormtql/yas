...
impl From<&WindowInfo> for StarRailRepositoryScanControllerWindowInfo {
    fn from(value: &WindowInfo) -> Self {
        StarRailRepositoryScanControllerWindowInfo {
            ...
            item_gap: value.get("starrail_repository_item_gap").unwrap(),
            item_size: value.get("starrail_repository_item_size").unwrap(),
            scan_margin: value.get("starrail_repository_scan_margin").unwrap(),
            pool_pos: value.get("starrail_repository_pool_pos").unwrap(),
        }
    }
}
...
impl RequireWindowInfo for StarRailRepositoryScanController {
    fn require_window_info(window_info_builder: &mut yas::window_info::window_info_builder::WindowInfoBuilder) {
        window_info_builder
            ...
            .add_required_key("starrail_repository_panel_pos")
            .add_required_key("starrail_repository_flag_pos")
            .add_required_key("starrail_repository_item_gap")
            .add_required_key("starrail_repository_item_size")
            .add_required_key("starrail_repository_scan_margin")
            .add_required_key("starrail_repository_pool_pos")
