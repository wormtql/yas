...
#[derive(Clone, Debug)]
pub struct GenshinScanInfo {
    pub shared: SharedScanInfo,

    pub sub_stat1_position: RectBound,
    pub sub_stat2_position: RectBound,
    pub sub_stat3_position: RectBound,
    pub sub_stat4_position: RectBound,
}
